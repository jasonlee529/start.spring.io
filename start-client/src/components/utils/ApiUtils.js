...
const PROPERTIES_MAPPING_URL = {
    ...
    jdbcHost: 'meta.jdbcHost',
    jdbcPort: 'meta.jdbcPort',
    jdbcDb: 'meta.jdbcDb',
    jdbcUsername: 'meta.jdbcUsername',
    jdbcPassword: 'meta.jdbcPassword',
}
...
export const getProject = function getProject(url, values, config) {
    return new Promise((resolve, reject) => {
        const params = querystring.stringify({
            ...
            jdbcHost: get(values,'meta.jdbcHost'),
            jdbcPort: get(values,'meta.jdbcPort'),
            jdbcDb: get(values,'meta.jdbcDb'),
            jdbcUsername: get(values,'meta.jdbcUsername'),
            jdbcPassword: get(values,'meta.jdbcPassword'),
        })
